...
**Current shipped technical interface:** `sdtk-code-kit@0.4.3` package + `sdtk-code` CLI

**Source checked:** package metadata and `node products/sdtk-code/distribution/sdtk-code-kit/bin/sdtk-code.js --help`
