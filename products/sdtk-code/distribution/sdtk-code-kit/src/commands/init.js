...
async function cmdInit(args) {
  ...
  assertProjectRefreshTargetAllowed("sdtk-code", "init", projectPath);
  ...
  console.log("Initializing SDTK-CODE workspace...");
  ...
  console.log("");
  console.log("SDTK-CODE workspace initialized successfully.");
  if (runtime === "codex" && scope === "project") {
  ...
  console.log("  2. Start the workflow with sdtk-code start once the upstream SDTK-SPEC handoff is ready.");
  return 0;
}
