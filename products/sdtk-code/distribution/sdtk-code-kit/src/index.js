...
const { cmdAgentTeam } = require("./commands/agent-team");
const { cmdGuardrails } = require("./commands/guardrails");
const { cmdHelp } = require("./commands/help");
const { cmdReadiness } = require("./commands/readiness");
...
const { cmdSleep } = require("./commands/sleep");
...
async function run(argv) {
  ...
  switch (command) {
    ...
    case "guardrails":
      return cmdGuardrails(args);
    case "readiness":
      return cmdReadiness(args);
    case "resume":
      return cmdResume(args);
    case "sleep":
      return cmdSleep(args);
    case "agent-team":
      return cmdAgentTeam(args);
    case "update":
