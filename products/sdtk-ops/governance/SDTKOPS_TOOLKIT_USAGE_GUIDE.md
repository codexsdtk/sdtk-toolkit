...
**Package:** `sdtk-ops-kit@0.2.9`

**CLI:** `sdtk-ops`

**Source checked:** package metadata and `node products/sdtk-ops/distribution/sdtk-ops-kit/bin/sdtk-ops.js --help`
...
Canonical downstream input from SDTK-CODE:
...
- `READY_FOR_SDTK_OPS`: start from `suggested_next_ops_path` or confirm the path with `ops-discover`.
- `BLOCKED_FOR_SDTK_OPS`: inspect blockers and evidence references; do not treat it as normal ready-path execution.
