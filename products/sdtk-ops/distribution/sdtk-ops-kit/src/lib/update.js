...
const PACKAGE_NAME = "sdtk-ops-kit";
const CLI_NAME = "sdtk-ops";
const CLI_BIN = path.resolve(__dirname, "..", "..", "bin", "sdtk-ops.js");
...
function parseUpdateOptions(args) {
  ...
  if (runtime && !flags["skip-project-files"]) {
    assertProjectRefreshTargetAllowed("sdtk-ops", "update", projectPath);
  }
...
function printPlan(plan) {
  console.log("SDTK-OPS update plan");
...
async function applyPlan(plan, options) {
  console.log("");
  console.log("Applying SDTK-OPS update...");
  ...
  console.log("");
  console.log("SDTK-OPS update completed successfully.");
}
