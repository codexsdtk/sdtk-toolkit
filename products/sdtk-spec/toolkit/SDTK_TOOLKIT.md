...
- `toolkit/session/SDTK_ACTIVE_BOOTSTRAP.md` -> `governance/ai/session/SDTK_ACTIVE_BOOTSTRAP.md`
- `toolkit/session/SDTK_AGENT_WORKING_RULES.md` -> `governance/ai/session/SDTK_AGENT_WORKING_RULES.md`
