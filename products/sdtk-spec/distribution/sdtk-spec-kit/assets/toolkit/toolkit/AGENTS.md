...
Goal: use SDTK-SPEC as a virtual PM/BA/ARCH/DEV/QA operating model to deliver one feature through a 6-phase SDLC flow with full traceability and quality gates.
