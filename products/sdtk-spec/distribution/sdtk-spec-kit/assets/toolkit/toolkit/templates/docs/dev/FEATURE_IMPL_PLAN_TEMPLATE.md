...
### 4.7 Impact Map
- The canonical generator emits an `impact_map` object (schema 0.2), auto-derived from the handoff refs; do not hand-author it.
- `impact_map` expected keys: `api_refs`, `database_refs`, `ui_refs`, `flow_refs`
